...
export class GouraudPhongRenderer extends Renderer {
    ...
    protected onInitialize(context: Context, callback: Invalidate,
        ...
        const frag = new Shader(context, gl.FRAGMENT_SHADER, 'phong.frag');
...
export class GouraudPhongExample extends Example {
