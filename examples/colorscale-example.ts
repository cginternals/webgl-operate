...
class ColorScaleRenderer extends Renderer {
    ...
    protected _presets: Array<[string, string, number, vec2]> = [
        ...
        // ['colorbrewer', 'BuPu', 4, vec2.fromValues(-0.45, -0.45)],
        // ['colorbrewer', 'BuPu', 7, vec2.fromValues(-0.45, -0.25)],
        // ['colorbrewer', 'RdPu', 4, vec2.fromValues(-0.45, -0.00)],
        // ['colorbrewer', 'RdPu', 7, vec2.fromValues(-0.45, +0.20)],
        // ['colorbrewer', 'Greys', 4, vec2.fromValues(-0.45, +0.45)],
        // ['colorbrewer', 'Greys', 7, vec2.fromValues(-0.45, +0.65)],

        ['colorbrewer', 'PuBu', 4, vec2.fromValues(+0.05, -0.90)],
        ['colorbrewer', 'PuBu', 128, vec2.fromValues(+0.05, -0.70)],
        ['colorbrewer', 'YlOrBr', 4, vec2.fromValues(+0.05, -0.45)],
        ['colorbrewer', 'YlOrBr', 128, vec2.fromValues(+0.05, -0.25)],
        ['colorbrewer', 'YlGnBu', 4, vec2.fromValues(+0.05, -0.00)],
        ['colorbrewer', 'YlGnBu', 128, vec2.fromValues(+0.05, +0.20)],
        ['colorbrewer', 'PuRd', 4, vec2.fromValues(+0.05, +0.45)],
        ['colorbrewer', 'PuRd', 128, vec2.fromValues(+0.05, +0.65)],
        ...
        ['smithwalt', 'viridis', 4, vec2.fromValues(+0.55, -0.90)],
        ['smithwalt', 'viridis', 8, vec2.fromValues(+0.55, -0.70)],
        ['smithwalt', 'viridis', 16, vec2.fromValues(+0.55, -0.45)],
        ['smithwalt', 'viridis', 32, vec2.fromValues(+0.55, -0.25)],
        ['smithwalt', 'viridis', 64, vec2.fromValues(+0.55, -0.00)],
        ['smithwalt', 'viridis', 128, vec2.fromValues(+0.55, +0.20)],
        ['smithwalt', 'viridis', 256, vec2.fromValues(+0.55, +0.45)],
        ['smithwalt', 'viridis', 512, vec2.fromValues(+0.55, +0.65)],
    ];
