...
//         gl.viewport(srcBounds[0], srcBounds[1], srcBounds[2] - srcBounds[0], srcBounds[3] - srcBounds[1]);

//         program.bind();
//         gl.uniform4fv(this._uSrcBounds, srcBounds);
//         gl.uniform4fv(this._uDstBounds, dstBounds);
