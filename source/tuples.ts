...
namespace tuples {
     ...
     */
    export function tuple2<T extends GLsizei | GLclampf | GLfloat>(buffer: vec2): [T, T] {
     ...
     */
    export function tuple3<T extends GLsizei | GLclampf | GLfloat>(buffer: vec3): [T, T, T] {
     ...
     */
    export function tuple4<T extends GLsizei | GLclampf | GLfloat>(buffer: vec4): [T, T, T, T] {
