...
export class IcoSphere extends Geometry {
    ...
    /**
     * Generates a sphere that is formed by subdividing the triangles of a regular icosahedron.
     * @param context - Valid context to create the object for.
     * @param subdivisions - Number of vertical segments.
     * @param identifier - Meaningful name for identification of this instance.
     */
    constructor(context: Context, subdivisions: number, identifier?: string) {
        ...
        /** @todo implement ico sphere generation here */
        assert(true, `ico sphere generation not implemented`);
