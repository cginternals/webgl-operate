...
//     /** @see {@link position} */
//     protected _position: vec2 = vec2.fromValues(0.0, 0.0);
//     /** @see {@link direction} */
//     protected _direction: vec2 = vec2.fromValues(1.0, 0.0);
//     /** @see {@link frameSize} */
//     protected _frameSize: vec2 = vec2.create();
...
//     - update transforms
//     - make all static ...
//     - or make all dynamic .. depending on label type
...
//     /**
//      * Sets the 2D direction parameters as specified in OpenLL. The labels's direction is the direction of its
// baseline.
...
//     /**
//      * This unit is used for the font size. This method overrides the super.fontSizeUnit, since a position2dlabel
// only
//      * allows px, not World.
//      * (@see {@link fontSize})
