...
```
<script src="https://cdn.jsdelivr.net/npm/webgl-operate@0.2.12/dist/webgl-operate.min.js"></script>
```
...
* ES6+ problems (breaks build due to the used UglifyJS only supporting ES5). Solution: use last ES5 version 
